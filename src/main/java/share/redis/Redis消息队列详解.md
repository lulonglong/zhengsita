...
除了发布和和订阅者，在消息队列中还有一个重要的概念：channel 意为频道或通道，可以理解为某个消息队列的名称。
...
![subscribe pattern](https://img-stage.yit.com/CMSRESQN/100c045299ea6e8ebcf6477e7b4ddbb4_1096X516.png)
...
### Stream的结构
![stream struct](https://img-stage.yit.com/CMSRESQN/196d6e616cd82428d3f612a0524c778b_643X440.png)
...
消费组消费示意图
![消费组消费示意图](https://img-stage.yit.com/CMSRESQN/88b18523509010f4f6f6fbe8c44e9861_1582X676.png)
...
![redis-stream-group-ack](https://img-stage.yit.com/CMSRESQN/9ae566d12703f778c44768fd2c730af5_1652X624.png)
* 查询未确认的消费队列
