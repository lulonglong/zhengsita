...
过期键判断流程如下图所示：
![过期键判断流程](https://img-stage.yit.com/CMSRESQN/b6e12709c7827748317631a3fb64d9a4_1024X880.png)

过期键数据结构如下图所示
![过期键数据结构](https://img-stage.yit.com/CMSRESQN/702fa0febbac0978286d38683719a14c_1374X776.png)
