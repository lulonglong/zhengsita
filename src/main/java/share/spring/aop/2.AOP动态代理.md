...
```
![alt proxy](https://asset-i7.yit.com/URDM/729e11646695b9c6686af9452791a77a_1096X870.png)
...
## CGLIB动态代理
	Spring直接完整地引入了CGLIB源码，看到包名中含有cglib，应该都是引入的CGLIB源代码
...
![alt enhancer](https://asset-i7.yit.com/URDM/fef2867e0dda49103098b9c35aa7b1b1_894X1950.png)
...
```
```
除此之外，CGLIB还针对代理类和被代理类另外生成了两个FastClass。
