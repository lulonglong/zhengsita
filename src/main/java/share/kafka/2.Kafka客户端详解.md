...
![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/kafka%E5%AE%A2%E6%88%B7%E7%AB%AF%E4%B8%BB%E6%9E%B6%E6%9E%84%E5%9B%BE.jpg)
...
根据 producer 处理此类故障所采取的提交策略类型，有如下三种：
...
Kafka实现的压缩方式是将多条消息一起进行压缩，这样可以保证较好的压缩效果。 在 一般情况下，生产者发送 的压缩数据在broker中也是保待压缩状态进行存储的，消费者从服务端获取的也是压缩的消息，消费者在处理消息之前才会解压消息，这样保待了端到端的压缩。

![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/%E5%8E%8B%E7%BC%A9%E6%B6%88%E6%81%AF.jpg)
...
![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/%E7%94%9F%E4%BA%A7%E8%80%85%E6%B1%A0%E5%8C%96%E5%A4%84%E7%90%86.png)

 ![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/%E7%94%9F%E4%BA%A7%E8%80%85%E5%88%A9%E7%94%A8%E6%B1%A0%E5%8C%96.png)
...
Kafka中的消费是基于拉模式的。Kafka中的消息消费是一个不断轮询的过程，消费者所要做的就是重复地调用poll()方法，而poll()方法返回的是所有订阅的主题（分区）上的一组消息。 
...
1. 每个consumer都会发送JoinGroup请求到计算出来的coordinator那台机器和是哪个
...
![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/WechatIMG358.jpeg)
...
![](https://img-blog.csdn.net/20180901161635810?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L21lbmdtZW5nZGFzdHlsZQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)  

如果提交的偏移量小于客户端处理的最后一个消息的偏移量，那么处于两个偏移量之间的消息就会被重复处理。

![](https://img-blog.csdn.net/20180901161708415?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L21lbmdtZW5nZGFzdHlsZQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70 ) 
...
![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/rebalance3.webp)
...
kafka原生没有提供延迟消息的支持，都是自研方案。常规解决方案

![](https://yit-integration.oss-cn-hangzhou.aliyuncs.com/CRM/TECH/%E5%BB%B6%E6%97%B6%E6%B6%88%E6%81%AF.jpg)



一条采用的类似上图的方案，只是没有对延迟进行分级，以下一条封装的部分代码
